   ...
   <div class="col-sm-4">
      <div class="pictureContainer">
         ...
         <div class="picture" class="text-center">
            ...
            @if ($f_constitucion)
            <embed id="pdf_f_constitucion" src='data:application/pdf;base64,{{ $f_constitucion }}' width='100%' type='application/pdf'>
            @else
   ...
   <div class="col-sm-4">
      <div class="pictureContainer">
         ...
         <div class="picture" class="text-center">
            ...
            @if ($f_nombramiento)
            <embed id="pdf_f_nombramiento" src='data:application/pdf;base64,{{ $f_nombramiento }}' width='100%' type='application/pdf'>
            @else
            <img class="rounded mx-auto d-block img-thumbnail imgCustom" src="{{ asset('assets/images/others/constitution.jpg') }}" alt="">
            @endif
   ...
   <div class="col-sm-4">
      <div class="pictureContainer">
         ...
         <div class="picture" class="text-center">
            ...
            @if ($f_nombramiento2)
            <embed id="pdf_f_nombramiento2" src='data:application/pdf;base64,{{ $f_nombramiento2 }}' width='100%' type='application/pdf'>
            @else
