...
<div class="row">
   ...
   <div class="col-sm-6">
      <div class="form-group">
         ...
         <input type="text" class="form-control mb-2" wire:model="empresa" placeholder="RAZON SOCIAL...">
         @error('empresa')
            <span class="text-danger"><small>{{ $message }}</small></span>
         @enderror
      </div>
   ...
   <div class="col-sm-3">
      <div class="form-group">
         ...
         <input type="text" class="form-control mb-2" wire:model="cargo" placeholder="GERENTE GENERAL...">
         @error('cargo')
            <span class="text-danger"><small>{{ $message }}</small></span>
         @enderror
      </div>
