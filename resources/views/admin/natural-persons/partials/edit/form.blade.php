<div class="row">
   <div class="col-sm-3">
      <div class="form-group">
         ...
         <select class="form-select text-uppercase mb-2 form-select-sm" wire:model="tipodocumento" id="tipodocumento" onfocusout="validar_Cedula(numerodocument)" wire:change="changeTypeDocument" autofocus required>
...
<div class="row">
   ...
   <div class="col-sm-4" style="display: {{ $numRuc }}">
      <div class="form-group">
         ...
         <input type="text" class="form-control mb-2 form-control-sm" minlength="13" maxlength="13" wire:model="ruc_personal" placeholder="17120083...001">
         @error('ruc_personal')
            <span class="text-danger"><small>{{ $message }}</small></span>
         @enderror
      </div>
   ...
   <div class="row">
      <div class="col-sm-4">
         <div class="form-group" wire:ignore>
            ...
            <select class="mb-2 form-select" id="partner" wire:model="partner" required>
