...
<div>
   <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
      <div>
         <h4 class="mb-3 mb-md-0">Editar Representante Legal</h4>
      </div>
      <nav aria-label="breadcrumb">
         <ol class="breadcrumb breadcrumb-dot">
            <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="{{ route('signatures') }}">Firmas</a></li>
            <li class="breadcrumb-item active" aria-current="page">Editar Representante Legal</li>
         </ol>
      </nav>
   </div>
   <div class="row">
      <div class="col-md-12 grid-margin stretch-card">
         <div class="card">
            <div class="card-body">
               ...
               @if ($currentStep === 1)
                  @include('admin.legal-representatives.partials.edit.form')
               @elseif($currentStep === 2)
                  @include('admin.legal-representatives.partials.edit.form2')
               @endif
               </form>
